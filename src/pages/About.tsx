export default function About() {
  return (
    <section
      id="about"
      className=" flex-2 justify-between items-center text-center py-10 px-5 "
    >
      <h1 className="text-4xl font-bold py-10 px-5 text-center text-[var(--color-secondary)] ">
        About <span className="text-[var(--color-text)]">Me</span>
      </h1>
      <div className=" flex justify-around place-items-baseline text-center px-15 py-3 gap-3 max-w-5xl mx-auto">
        <img
